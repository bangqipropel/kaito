...
class MilvusVectorStoreHandler(BaseVectorStore):
    ...
    def _restore_indexes_from_milvus(self):
        ...
        try:
            ...
            logger.info(
                f"Found {len(collections)} existing Milvus collection(s): "
                f"{collections}"
            )
    ...
    async def delete_index(self, index_name: str):
        ...
        try:
            ...
            logger.warning(
                f"Failed to drop Milvus collection '{index_name}': {e}"
            )
        ...
        try:
            ...
            while len(docs) < limit and milvus_offset < total_count:
                ...
                for entity in entities:
                    ...
                    docs.append(
                        self._entity_to_doc_dict(entity, max_text_length)
                    )
            ...
            logger.error(f"Failed to list documents in Milvus collection '{index_name}': {e}")
            ...
            for doc_id in doc_ids:
                ...
                if result:
                    ...
                    try:
                        ...
                        pass  # docstore might not have it
